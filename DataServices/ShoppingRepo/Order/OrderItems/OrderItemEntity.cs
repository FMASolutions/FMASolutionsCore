...
namespace FMASolutionsCore.DataServices.ShoppingRepo
{
    public class OrderItemEntity : IBaseEntity
    {
        ...
        public OrderItemEntity(Int32 orderItemID, Int32 orderHeaderID, Int32 itemID, decimal orderItemUnitPrice, decimal orderItemUnitPriceAfterDiscount, Int32 orderItemQuantity, string orderItemDescritpion)
        {
            ...
            _orderItemQuantity = orderItemQuantity;
        ...
        protected int _orderItemQuantity;
        ...
        public int OrderItemQuantity { get { return _orderItemQuantity; } set { _orderItemQuantity = value; } }
