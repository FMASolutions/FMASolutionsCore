...
namespace FMASolutionsCore.DataServices.ShoppingRepo
{
    public class CustomerAddressEntity : IBaseEntity
    {
        ...
        public CustomerAddressEntity(Int32 customerAddressID, Int32 customerID, Int32 addressLocationID, string customerAddressDescription, bool isDefaultAddress = true)
        {
