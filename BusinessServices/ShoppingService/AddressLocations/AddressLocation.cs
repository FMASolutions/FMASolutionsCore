...
namespace FMASolutionsCore.BusinessServices.ShoppingService
{
    ...
    {
        public AddressLocation(ICustomModelState modelState, int addressLocationID = 0, string addressLocationCode = "", int cityAreaID = 0, int postCodeID = 0, string addressLine1 = "", string addressLine2 = "")
        {
